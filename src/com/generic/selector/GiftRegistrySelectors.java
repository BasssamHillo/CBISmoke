...
public class GiftRegistrySelectors {
	...
	public static final cselector GHCreateRegistryButton = new cselector("css,[onclick*=submitCreateRegistyLogon]","css,.responsive-content [onclick*=submitCreateRegisty]");
